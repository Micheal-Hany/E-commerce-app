...
//     getCategoryData();
//      getItemsData("${tabController.index}");
...
//     var response = await homeData.getCategoryData();
...
//   Future<void> getItemsData(String id) async {
//     stateRequest = StatusRequest.loading;
//     var response = await homeData.getItemsData(id);
